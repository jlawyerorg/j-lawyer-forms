            ...
            SCRIPTPANEL=panel(size: [300, 300]) {
                tableLayout (cellpadding: 5) {
                    ...
                    tr {
                        ...
                        td  {
                            txtBescheidTitel=textField(name: "_BESCHEID-TITEL", clientPropertyJlawyerdescription: "Titel des Bescheids", text: '', columns:60, keyReleased: { erstellen() })
                    ...
                    tr {
                        ...
                        td  {
                            txtBescheidDatum=textField(name: "_BESCHEID-DATUM", clientPropertyJlawyerdescription: "Datum des Bescheids", text: '', columns:10, keyReleased: { erstellen() })
                        }
                    }
					...
					tr {
                        ...
                        td  {
                            txtWsDatum=textField(name: "_WS-DATUM", text: '', clientPropertyJlawyerdescription: "Datum des Widerspruchs", columns:10, keyReleased: { erstellen() })
                        }
                    }
					...
					tr {
                        ...
                        td  {
                            txtWsSendeDatum=textField(name: "_SENDE-DATUM", text: '', clientPropertyJlawyerdescription: "Datum des Sendenachweises", columns:10, keyReleased: { erstellen() })
                        }
                    }
                    ...
                    tr {
                        ...
                        td  {
                            cmbWsSendeart = comboBox(items: [
                                            ...
                                            'Fax',
                                            'Brief'
                                ], name: "_WS_SENDE-ART", clientPropertyJlawyerdescription: "Übersendungsweg", editable: true, actionPerformed: { erstellen() }
                            )
                        }
                    }
                    tr {
                        ...
                        td {
                            ...
                            rdEingangJa=radioButton (text: 'Ja', name: "_BESTAETIGUNG-JA", clientPropertyJlawyerdescription: "Eingangsbestätigung: ja", buttonGroup: btnGrpEingang, selected: true, actionPerformed: {
                                    erstellen()
                                })
                    ...
                    tr {
                        ...
                        td {
                            rdEingangNein=radioButton (text: 'Nein', name: "_BESTAETIGUNG-NEIN", clientPropertyJlawyerdescription: "Eingangsbestätigung: nein", buttonGroup: btnGrpEingang, actionPerformed: {  
                                    erstellen()
                                })
                        }
                    }
					tr {
                        ...
                        td  {
                            txtWsBestaetigungDatum=textField(name: "_BESTAETIGUNG-DATUM", clientPropertyJlawyerdescription: "Datum der Eingangsbestätigung", text: '', columns:10, keyReleased: { erstellen() })
                        }
                    }
					...
					tr {
                        ...
                        td {
                            ...
                            rdPkhJa=radioButton (text: 'Ja', name: "_PKH-JA", clientPropertyJlawyerdescription: "PKH beantragen: ja", buttonGroup: btnGrpPKH, selected: true, actionPerformed: {
                                    erstellen()
                                })
                    ...
                    tr {
                        ...
                        td {
                            rdPkhNein=radioButton (text: 'Nein', name: "_PKH-NEIN", clientPropertyJlawyerdescription: "PKH beantragen: nein", buttonGroup: btnGrpPKH, actionPerformed: {  
                                    erstellen()
                                })
                        }
                    }
                                        ...
                                        td {
                                            panel{
                                                scrollPane(preferredSize:[850, 800]){
                                                    lblText=textArea(text: 'Musterschriftsatz', clientPropertyJlawyerdescription: "Musterschriftsatz", lineWrap: true, wrapStyleWord: true)
                                                }
                                            }
                                        }
                                    }
